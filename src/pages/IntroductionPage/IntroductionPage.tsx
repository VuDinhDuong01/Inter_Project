      ...
      <div className='xl:pr-[242px] 2xl:pr-0   2xl:mt-[120px] 2xl:max-w-[1071px]   2xl:max-h-[395px] 2xl:m-auto xl:bg-transparent 2xl:mb-[47px]  xl:h-[395px] 2xl:h-[395px] xl:pl-[127px] 2xl:pl-0 grid w-full xl:grid-cols-2 grid-cols-1 2xl:gap-[99px]'>
        <div className='col-span-1 xl:px-0 px-[20px] 2xl:px-0'>
          ...
          <div >
            ...
            <p className='text-black text-right font-FontSan font-[500] xl:text-[16px] lg:px-[30px] 2xl:px-0 lg:text-[20px]   leading-[24px]'>{t('IntroductionPage.VisionAndMissionDescriptions2')}</p>
            <p className='text-black text-right font-FontSan font-[500] xl:text-[16px] lg:px-[30px] 2xl:px-0 lg:text-[20px]   leading-[24px]'>{t('IntroductionPage.VisionAndMissionDescriptions3')}</p>
            <p className='text-black text-right font-FontSan font-[500] xl:text-[16px] lg:px-[30px] 2xl:px-0 lg:text-[20px]   leading-[24px]'>{t('IntroductionPage.VisionAndMissionDescriptions4')}</p>
            <p className='text-black text-right font-FontSan font-[500] xl:text-[16px] lg:px-[30px] 2xl:px-0 lg:text-[20px]   leading-[24px]'>{t('IntroductionPage.VisionAndMissionDescriptions5')}</p>
          </div>
        </div>
