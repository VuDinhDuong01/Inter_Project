...
export const Banner = (
  ...
  return (
    <div className="lg:pl-[112px] justify-between lg:pr-[132px] w-full lg:h-[260px] lg:mb-[120px] mb-[50px] lg:flex lg:bg-[#E9F9D6] bg-[#CEFFE8]">
      <div style={{ marginTop: `${marginTop1}px` }} className='lg:flex hidden'>
      ...
      <div className="flex flex-col items-center justify-center">
        {
          img ? (<img src={img} className="object-cover lg:w-[387px] lg:h-[36px] lg:px-0 px-[20px] lg:my-0 my-[50px]" />) : <h2 className="text-green lg:text-[32px] text-[25px] text-center font-[700] leading-[32px] lg:mb-[6px] mb-[15px] lg:mt-0 mt-[30px]">{content}</h2>
        }
